...
# PRETRAINED_WEIGHTS = "models/unet/unet_drivable_best.pth"
PRETRAINED_WEIGHTS = f"models/unet/unet_ofrd_round{ROUND_NUM-1}.pth"

FINETUNE_DIR = Path("models/unet")
...
def main():
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_iou > best_iou:
            best_iou = val_iou
            best_path = FINETUNE_DIR / f"unet_ofrd_round{ROUND_NUM}.pth"
